...
import { Screen, StatusBar, Content, FooterActions, Button, TopBar, SummaryRow, Callout } from '../../components/ui.jsx';
...
export default function Cotizador() {
  ...
  return (
    <Screen>
      <StatusBar />
      <TopBar title="Seleccionar oferta" onClose={() => navigate('/solicitud')} onBack={null} />
      <Content>
